...
| [`2026-09-25-feat-couch-mode-plan.md`](2026-09-25-feat-couch-mode-plan.md) | 2026-09-25 | **In progress.** Couch mode for #62: the desktop is a seat-less table and phones are the hands. U34–U42 and KTD23–32. The table's view, protocol v3 and the table connection (U34–U36) are built |
